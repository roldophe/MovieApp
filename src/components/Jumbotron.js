...
const Jumbotron = () => {
    const [mvoie,setMovie] =useState(null);
    useEffect(() => {
    ...
    return (
        <section
            class="container px-2 lg:pl-6 mx-auto bg-center bg-cover bg-no-repeat bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg')] bg-gray-700 bg-blend-multiply"
        >
            <div
                class="px-4 lg:pl-6 max-w-screen-xl text-center py-14 lg:py-46"
            >
                <h1
